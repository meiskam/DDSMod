...
namespace CG
{
	...
	public:
		...
		int32_t                                                    PolicemenAlerted;                                        // 0x0340(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void UserConstructionScript();
		void ReceiveBeginPlay();
		void ExecuteUbergraph_SecurityCameraAlertRadius(int32_t EntryPoint);
