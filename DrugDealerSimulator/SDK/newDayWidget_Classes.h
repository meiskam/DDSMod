...
namespace CG
{
	...
	public:
		...
		class UTextBlock*                                          txtDay;                                                  // 0x0218(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Construct();
		void Setup(const class FText& DayNam);
		void ExecuteUbergraph_newDayWidget(int32_t EntryPoint);
