...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NSKJ[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_COZH[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K3U4[0x5];                                   // 0x00E3(0x0005) MISSED OFFSET (PADDING)
	};
