...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_HWAE[0x6];                                   // 0x0392(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SmugglersTask();
		void ExecuteUbergraph_smugglerLaundryDialogueInstance(int32_t EntryPoint);
