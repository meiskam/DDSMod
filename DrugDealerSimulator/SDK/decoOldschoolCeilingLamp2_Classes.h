...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1M5K[0x2];                                   // 0x0446(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_decoOldschoolCeilingLamp2(int32_t EntryPoint);
