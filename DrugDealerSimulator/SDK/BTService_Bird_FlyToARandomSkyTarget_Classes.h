...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_0Z90[0x4];                                   // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_BTService_Bird_FlyToARandomSkyTarget(int32_t EntryPoint);
