...
namespace CG
{
	...
	public:
		...
		struct FCoreUObject_FTransform STATIC_K2_LookAt(const struct FCoreUObject_FTransform& CurrentTransform, const struct FVector& TargetPosition, const struct FVector& LookAtVector, bool bUseUpVector, const struct FVector& UpVector, float ClampConeInDegree);
	...
	public:
		...
		unsigned char                                              UnknownData_94XZ[0x30];                                  // 0x0078(0x0030) MISSED OFFSET (PADDING)
