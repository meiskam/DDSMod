...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_N83T[0x3];                                   // 0x0355(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x0358(0x0008) ZeroConstructor, Transient, DuplicateTransient

	public:
		void UserConstructionScript();
		void playerLookedAt();
		void ExecuteUbergraph_keijiTerritoryLook(int32_t EntryPoint);
