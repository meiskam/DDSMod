...
namespace CG
{
	...
	{
	public:
		void STATIC_UpdateExternalTrackingHMDPosition(const struct FCoreUObject_FTransform& ExternalTrackingTransform);
		...
		struct FCoreUObject_FTransform STATIC_GetTrackingToWorldTransform(class UObject* WorldContext);
		...
		void STATIC_CalibrateExternalTrackingToHMD(const struct FCoreUObject_FTransform& ExternalTrackingTransform);
		static UClass* StaticClass();
	};

	/**
	 * Class HeadMountedDisplay.MotionControllerComponent
	 * Size -> 0x00B0 (FullSize[0x0610] - InheritedSize[0x0560])
	 */
	...
	public:
		...
		unsigned char                                              bDisableLowLatencyUpdate : 1;                            // 0x0568(0x0001) BIT_FIELD Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_LI33[0x3];                                   // 0x0569(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XYYV[0x2];                                   // 0x056E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FIUM[0x60];                                  // 0x0590(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GV7C[0x18];                                  // 0x05F8(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		class UPrimitiveComponent* STATIC_AddNamedDeviceVisualizationComponentBlocking(class AActor* Target, const class FName& SystemName, const class FName& DeviceName, bool bManualAttachment, const struct FCoreUObject_FTransform& RelativeTransform, struct FXRDeviceId* XRDeviceId);
		class UPrimitiveComponent* STATIC_AddDeviceVisualizationComponentBlocking(class AActor* Target, const struct FXRDeviceId& XRDeviceId, bool bManualAttachment, const struct FCoreUObject_FTransform& RelativeTransform);
		static UClass* StaticClass();
	};
	...
	public:
		...
		unsigned char                                              UnknownData_49OI[0x8];                                   // 0x0050(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		class UAsyncTask_LoadXRDeviceVisComponent* STATIC_AddNamedDeviceVisualizationComponentAsync(class AActor* Target, const class FName& SystemName, const class FName& DeviceName, bool bManualAttachment, const struct FCoreUObject_FTransform& RelativeTransform, struct FXRDeviceId* XRDeviceId, class UPrimitiveComponent** NewComponent);
		class UAsyncTask_LoadXRDeviceVisComponent* STATIC_AddDeviceVisualizationComponentAsync(class AActor* Target, const struct FXRDeviceId& XRDeviceId, bool bManualAttachment, const struct FCoreUObject_FTransform& RelativeTransform, class UPrimitiveComponent** NewComponent);
		static UClass* StaticClass();
	};
