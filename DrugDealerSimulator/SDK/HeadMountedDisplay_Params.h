...
namespace CG
{
	...
	{
	public:
		struct FCoreUObject_FTransform                             ExternalTrackingTransform;                               // 0x0000(0x0030)  (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	};
	...
	public:
		...
		struct FCoreUObject_FTransform                             RelativeTransform;                                       // 0x0000(0x0030)  (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
