...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DFZ7[0x4];                                   // 0x08DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CitizenMale01_animBP(int32_t EntryPoint);
