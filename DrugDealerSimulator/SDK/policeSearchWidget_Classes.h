...
namespace CG
{
	...
	public:
		...
		class UProgressBar*                                        progSearch;                                              // 0x0218(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Construct();
		void ExecuteUbergraph_policeSearchWidget(int32_t EntryPoint);
