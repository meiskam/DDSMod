...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_Y05X[0x300];                                 // 0x0028(0x0300) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_03DJ[0xF8];                                  // 0x033C(0x00F8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EUKJ[0x1E4];                                 // 0x043C(0x01E4) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_38N1[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
