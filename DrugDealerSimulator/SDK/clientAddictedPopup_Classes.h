...
namespace CG
{
	...
	public:
		...
		class UTextBlock*                                          txtOverdose;                                             // 0x0228(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Construct();
		void Setup(const class FText& ClientName, const class FText& ClientAddictionDrug);
		void ExecuteUbergraph_clientAddictedPopup(int32_t EntryPoint);
