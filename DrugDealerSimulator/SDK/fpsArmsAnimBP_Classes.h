...
namespace CG
{
	 ...
	 * Size -> 0x07C3 (FullSize[0x0B23] - InheritedSize[0x0360])
	 */
	...
	public:
		...
		bool                                                       phoneIsUp;                                               // 0x0B20(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       IsJumping;                                               // 0x0B21(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       hasLanded;                                               // 0x0B22(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_fpsArmsAnimBP(int32_t EntryPoint);
