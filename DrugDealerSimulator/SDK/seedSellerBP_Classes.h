...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_SGLB[0x4];                                   // 0x0AD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void trySedGoHome();
		void seedGotHome();
		void ExecuteUbergraph_seedSellerBP(int32_t EntryPoint);
