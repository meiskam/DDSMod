...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_GGLF[0x4];                                   // 0x0AD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_npcPharmacist(int32_t EntryPoint);
