...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0XL7[0x2];                                   // 0x0446(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_decoOldschoolCeilingLamp1(int32_t EntryPoint);
