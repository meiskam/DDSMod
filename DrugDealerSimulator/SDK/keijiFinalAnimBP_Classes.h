...
namespace CG
{
	 ...
	 * Size -> 0x065D (FullSize[0x09BD] - InheritedSize[0x0360])
	 */
	...
	public:
		...
		int32_t                                                    AnimStep;                                                // 0x09B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       Reset;                                                   // 0x09BC(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void ExecuteUbergraph_keijiFinalAnimBP(int32_t EntryPoint);
