...
namespace CG
{
	...
	public:
		...
		class UTextBlock*                                          txtExpAmount;                                            // 0x0220(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Construct();
		void Setup(float expAmount);
		void ExecuteUbergraph_expEarnedPopup(int32_t EntryPoint);
