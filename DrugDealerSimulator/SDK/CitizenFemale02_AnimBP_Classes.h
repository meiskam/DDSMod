...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PW6Q[0x4];                                   // 0x05F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CitizenFemale02_AnimBP(int32_t EntryPoint);
