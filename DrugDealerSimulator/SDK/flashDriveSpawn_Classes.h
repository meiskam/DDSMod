...
namespace CG
{
	...
	public:
		...
		class UBoxComponent*                                       blocker;                                                 // 0x0330(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_flashDriveSpawn(int32_t EntryPoint);
