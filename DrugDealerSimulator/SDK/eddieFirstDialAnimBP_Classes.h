...
namespace CG
{
	 ...
	 * Size -> 0x09D5 (FullSize[0x0D35] - InheritedSize[0x0360])
	 */
	...
	public:
		...
		bool                                                       giveJoint;                                               // 0x0D30(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       afterJoint;                                              // 0x0D31(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       tellStory;                                               // 0x0D32(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       briefing;                                                // 0x0D33(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		bool                                                       Finish;                                                  // 0x0D34(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor

	public:
		void AnimNotify_pullOutPhone();
		void ExecuteUbergraph_eddieFirstDialAnimBP(int32_t EntryPoint);
