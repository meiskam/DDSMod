...
namespace CG
{
	...
	public:
		...
		class ArentAppartmentArea_C*                               Hideout;                                                 // 0x0340(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void UserConstructionScript();
		void RentHideout();
		void ExecuteUbergraph_SectorHidoutUnlocker(int32_t EntryPoint);
