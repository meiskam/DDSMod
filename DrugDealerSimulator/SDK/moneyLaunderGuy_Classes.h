...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_NNJP[0x4];                                   // 0x0AD4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void endWaiting();
		void launderGotHome();
		void ExecuteUbergraph_moneyLaunderGuy(int32_t EntryPoint);
