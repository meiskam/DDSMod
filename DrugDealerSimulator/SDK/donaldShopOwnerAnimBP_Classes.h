...
namespace CG
{
	 ...
	 * Size -> 0x0540 (FullSize[0x08A0] - InheritedSize[0x0360])
	 */
	...
	public:
		...
		bool                                                       IsClient;                                                // 0x0890(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		unsigned char                                              UnknownData_LF7Z[0x3];                                   // 0x0891(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRotator                                            headRot;                                                 // 0x0894(0x000C) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor

	public:
		void BlueprintUpdateAnimation(float DeltaTimeX);
		void ExecuteUbergraph_donaldShopOwnerAnimBP(int32_t EntryPoint);
