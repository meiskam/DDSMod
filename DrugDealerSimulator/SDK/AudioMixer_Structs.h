...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Z8JH[0x2];                                   // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WEVA[0x3];                                   // 0x0025(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_65QZ[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
