...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_13PO[0x2];                                   // 0x0446(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void InputToggleOff();
		void InputToggleOn();
		void ExecuteUbergraph_BP_decoDeskLamp4(int32_t EntryPoint);
