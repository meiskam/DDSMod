...
namespace CG
{
	...
	{
	public:
		class UStaticMeshComponent*                                lampMesh;                                                // 0x0328(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
