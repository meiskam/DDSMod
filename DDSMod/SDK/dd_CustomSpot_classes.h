...
public:
	...
	struct FText                                       CustomStotName;                                           // 0x0488(0x0018) (Edit, BlueprintVisible)
	struct FVector                                     colliderExtent;                                           // 0x04A0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
